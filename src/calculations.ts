...
export const categories: (keyof CategoryScores)[] = [
  "design",
  "writing",
  "development",
  "research",
...
export function assessmentToCategoryScores(
  ...
  return {
    design: {
      ...
      score: Math.round(mean(designSkillAssessment)),
    },
    research: {
      progress: {
      ...
      score: Math.round(mean(researchSkillAssessment)),
    },
    writing: {
      progress: {
      ...
      score: Math.round(mean(writingSkillAssessment)),
    },
    development: {
      progress: {
      ...
      score: Math.round(mean(developmentSkillAssessment)),
    },
    managing: {
      progress: {
        total: 10,
